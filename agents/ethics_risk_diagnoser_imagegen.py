...
try:
    ...
    from ..core.db_utils import search_documents, past_cases_collection # checklist_collection 제거
    from ..core.config import LLM_MODEL_NAME, OPENAI_API_KEY, TAVILY_API_KEY, TOP_K_RESULTS
except ImportError:
    from core.states import ProjectState, PastCaseAnalysis
    from core.db_utils import search_documents, past_cases_collection
